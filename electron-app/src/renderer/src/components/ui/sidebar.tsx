...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer text-sidebar-foreground block shrink-0 w-[var(--sidebar-width)] data-[collapsible=icon]:w-[var(--sidebar-width-icon)] transition-[width] duration-200 ease-linear"
        data-state={state}
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ...
              : "group-data-[collapsible=icon]:w-[var(--sidebar-width-icon)] border-sidebar-border group-data-[side=left]:border-r-2 group-data-[side=right]:border-l",
            className
          )}
          {...props}
        >
